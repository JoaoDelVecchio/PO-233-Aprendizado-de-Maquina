...
def __main__():
    ...
    with open('C:\\Users\\delve\\OneDrive\\Eu\\GitHub\\PO-233-Aprendizado-de-Maquina\\Coleta de dados\\Entradas\\entrada_AXP.txt', 'r') as file:
        line_count = 0
        processed_lines = []
        processed_lines1 = []
        processed_lines2 = []
    ...
    # Salvando arquivo
    df_combined.to_csv('C:\\Users\\delve\\OneDrive\\Eu\\GitHub\\PO-233-Aprendizado-de-Maquina\\Coleta de dados\\Data\\Data_AXP.csv', index = True)
